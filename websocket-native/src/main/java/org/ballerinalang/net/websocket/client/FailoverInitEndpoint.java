...
//import org.ballerinalang.net.websocket.client.listener.FailoverConnectorListener;
...
//
//    public static void initEndpoint(Environment env, BObject failoverClient) {
...
//
//    /**
//     * Checks whether the URL has a valid format or not. If it isn't in the valid format, removes that from the URL
//     set.
//     *
