...
public class WebSocketServicesRegistry {
    ...
    public void registerService(WebSocketServerService service) {
        ...
        try {
            ...
            throw WebSocketUtil.getWebSocketError("", e, WebSocketConstants.ErrorCode.GenericError.
                    errorCode(), null);
        }
    ...
    public BError unRegisterService(BObject serviceObj) {
        try {
            ...
            return WebSocketUtil.getWebSocketError("", e, WebSocketConstants.ErrorCode.GenericError.
                    errorCode(), null);
        } catch (BError e) {
            return e;
        }
