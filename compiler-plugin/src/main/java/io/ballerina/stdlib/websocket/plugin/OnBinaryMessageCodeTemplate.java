...
/**
 * Code action to add onBinaryMessage remote function.
 */
public class OnBinaryMessageCodeTemplate implements CodeAction {
    ...
    public List<String> supportedDiagnosticCodes() {
        return List.of(PluginConstants.CompilationErrors.ON_BINARY_GENERATION_HINT.getErrorCode());
    }

    @Override
    public Optional<CodeActionInfo> codeActionInfo(CodeActionContext codeActionContext) {
        return Utils.getCodeActionInfo(codeActionContext, "Add onBinaryMessage function");
    }

    @Override
    public List<DocumentEdit> execute(CodeActionExecutionContext codeActionExecutionContext) {
        return Utils.getDocumentEdits(codeActionExecutionContext, ON_BINARY_FUNCTION);
    }

    @Override
    public String name() {
        return "ADD_ON_BINARY_CODE_SNIPPET";
    }
}
