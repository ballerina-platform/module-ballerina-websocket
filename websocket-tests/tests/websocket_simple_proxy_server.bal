...
service on new websocket:Listener(21018) {

    resource function onOpen(websocket:WebSocketCaller wsEp) {
        websocket:WebSocketClient wsClientEp = new ("ws://localhost:21019/websocket", {
                callbackService:
...
service proxyServer on new websocket:Listener(21019) {
...
service clientCallbackService9 = @websocket:WebSocketServiceConfig {} service {
...
service proxyCallbackService = @websocket:WebSocketServiceConfig {} service {
    resource function onText(websocket:WebSocketClient wsEp, string text) {
...
public function testSendText() {
    websocket:WebSocketClient wsClient = new ("ws://localhost:21018", {callbackService: proxyCallbackService});
