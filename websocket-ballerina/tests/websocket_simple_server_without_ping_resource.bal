...
service pongService = @WebSocketServiceConfig {} service {

    resource function onPong(WebSocketClient wsEp, byte[] data) {
...
public function testAutoPingPongSupport() {
    WebSocketClient wsClient = new ("ws://localhost:21020", {callbackService: pongService});
