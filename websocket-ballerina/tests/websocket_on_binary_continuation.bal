...
service continuationService = @WebSocketServiceConfig {} service {

    resource function onBinary(WebSocketClient caller, byte[] data, boolean finalFrame) {
...
public function testBinaryContinuation() {
    ...
    WebSocketClient wsClient = new ("ws://localhost:21007/onBinaryContinuation",
