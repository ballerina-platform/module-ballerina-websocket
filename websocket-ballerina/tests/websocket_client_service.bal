...
//    WebSocketClient wsClient = new ("ws://localhost:21021/client/service", {callbackService: ClientService200});
...
//    isClientConnectionOpen = false;
//    WebSocketClient|error wsClientEp = trap new ("ws://localhost:21021/client/service",
