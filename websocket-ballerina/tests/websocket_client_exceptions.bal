...
service errorResourceService = @WebSocketServiceConfig {} service {
    resource function onError(WebSocketClient clientCaller, error err) {
...
service errorServer on new Listener(21030) {
    ...
    resource function onClose(WebSocketCaller ep, int statusCode, string reason) {
    }
}
