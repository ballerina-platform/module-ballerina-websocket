...
// listener Listener l45 = new(21315);

// service /cookie on l45 {
...
//        return new WsService45(customHeaders);
//    }
// }

// service class WsService45 {
...
// @test:Config {}
// public function testSendCookieWithAsyncClient() returns error? {
//    AsyncClient wsClient = check new("ws://localhost:21315/cookie/", config = clientEPConfig);
