...
public class CodeSnippetGenerationCodeActionTest extends AbstractCodeActionTest {
    ...
    private Object[][] testDataProvider() {
        return new Object[][]{
                ...
                {"on_open.bal", 25, 3, getExpectedCodeActionForWsService("on_open.bal", 26, 1,
                        "WEBSOCKET_114", "ADD_ON_OPEN_CODE_SNIPPET",
                        "Add onOpen function"), "on_open.bal", "sample_package_37"},
                {"on_close.bal", 25, 3, getExpectedCodeActionForWsService("on_close.bal", 26, 1,
                        "WEBSOCKET_111", "ADD_ON_CLOSE_CODE_SNIPPET",
                        "Add onClose function"), "on_close.bal", "sample_package_46"},
                {"on_binary.bal", 25, 3, getExpectedCodeActionForWsService("on_binary.bal", 26, 1,
                        "WEBSOCKET_110", "ADD_ON_BINARY_CODE_SNIPPET",
                        "Add onBinaryMessage function"), "on_binary.bal", "sample_package_47"},
                {"on_text.bal", 25, 3, getExpectedCodeActionForWsService("on_text.bal", 26, 1,
                        "WEBSOCKET_117", "ADD_ON_TEXT_CODE_SNIPPET",
                        "Add onTextMessage function"), "on_text.bal", "sample_package_48"},
                {"on_message.bal", 25, 3, getExpectedCodeActionForWsService("on_message.bal", 26, 1,
                        "WEBSOCKET_118", "ADD_ON_MESSAGE_CODE_SNIPPET",
                        "Add onMessage function"), "on_message.bal", "sample_package_49"},
                {"on_ping.bal", 25, 3, getExpectedCodeActionForWsService("on_ping.bal", 26, 1,
                        "WEBSOCKET_115", "ADD_ON_PING_CODE_SNIPPET",
                        "Add onPing function"), "on_ping.bal", "sample_package_50"},
                {"on_pong.bal", 25, 3, getExpectedCodeActionForWsService("on_pong.bal", 26, 1,
                        "WEBSOCKET_116", "ADD_ON_PONG_CODE_SNIPPET",
                        "Add onPong function"), "on_pong.bal", "sample_package_51"},
                {"on_error.bal", 25, 3, getExpectedCodeActionForWsService("on_error.bal", 26, 1,
                        "WEBSOCKET_112", "ADD_ON_ERROR_CODE_SNIPPET",
                        "Add onError function"), "on_error.bal", "sample_package_52"},
                {"on_idletimeout.bal", 25, 3, getExpectedCodeActionForWsService("on_idletimeout.bal", 26, 1,
                        "WEBSOCKET_113", "ADD_ON_IDLE_TIMEOUT_CODE_SNIPPET",
                        "Add onIdleTimeout function"), "on_idletimeout.bal", "sample_package_53"}
        };
    }
    ...
    private CodeActionInfo getExpectedCodeActionForWsService(String filePath, int line, int offset,
                             String diagnosticCode, String diagnosticName, String codeActionName) {
